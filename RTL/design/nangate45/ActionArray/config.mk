export DESIGN_NAME = ActionArray
...
export VERILOG_FILES = \
	...
	$(abspath $(DESIGN_DIR))/../../src/actions/ActionArray.sv
...
# Tighten IO pin spacing to increase capacity
export PLACE_PINS_ARGS = -min_distance 0.00 -corner_avoidance 0