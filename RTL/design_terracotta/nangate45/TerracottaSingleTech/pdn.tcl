...
####################################
# standard cell grid — wider metal4 pitch (112μm) to fit through inter-macro channels
# Default is 56μm; 64 dense SRAMs leave narrow gaps that can't accommodate many stripes
####################################
...
add_pdn_stripe -grid {grid} -layer {metal4} -width {0.48} -pitch {224.0} -offset {5}
