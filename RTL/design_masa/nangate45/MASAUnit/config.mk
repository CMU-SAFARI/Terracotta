export DESIGN_NAME = MASAUnit
export PLATFORM    = nangate45

# Source files (relative to DESIGN_DIR which is this directory)
export VERILOG_FILES = \
	$(abspath $(DESIGN_DIR))/../../src/masa_types_pkg.sv \
	$(abspath $(DESIGN_DIR))/../../src/SubarraySelector.sv \
	$(abspath $(DESIGN_DIR))/../../src/CaBusEncoder.sv \
	$(abspath $(DESIGN_DIR))/../../src/MASAUnit.sv
