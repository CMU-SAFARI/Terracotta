export DESIGN_NAME = PRADAUnit
export PLATFORM    = nangate45

# Source files (relative to DESIGN_DIR which is this directory)
export VERILOG_FILES = \
	$(abspath $(DESIGN_DIR))/../../src/prada_types_pkg.sv \
	$(abspath $(DESIGN_DIR))/../../src/BankStateTracker.sv \
	$(abspath $(DESIGN_DIR))/../../src/CaBusEncoderPrada.sv \
	$(abspath $(DESIGN_DIR))/../../src/PRADAUnit.sv
