...
class DDR5PRADA : public IDRAM, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IDRAM, DDR5PRADA, "DDR5PRADA", "DDR5 PRADA Device Model")
  private:
    int m_RH_radius = -1;
  ...
  public:
    struct Node : public DRAMNodeBase<DDR5PRADA> {
      Node(DDR5PRADA* dram, Node* parent, int level, int id) : DRAMNodeBase<DDR5PRADA>(dram, parent, level) {
        m_node_id = id;
      ...
      void update_timing_prada(int command, const AddrVec_t& addr_vec, Clk_t clk) {
        ...
        auto* dram = static_cast<DDR5PRADA*>(m_spec);
  ...
  private:
    ...
    void set_timing_vals() {
      ...
      // (Controller: controller_latency). Custom PRADA charges it at channel level only.
      new_cmd_latency = 2;
      ...
      std::vector<TimingConsInitializer> initializer = {
        ...
        /*** Bank ***/ 
        {.level = "bank", .preceding = {"ACTwl"}, .following = {"NOT", "PRE", "PREsb"}, .latency = V("nWR")},

        {.level = "bank", .preceding = {"ACTwls"}, .following = {"ACTwl"}, .latency = V("nRAS") / 2},
        {.level = "bank", .preceding = {"ACTwls"}, .following = {"NOT", "PRE", "PREsb"}, .latency = nACTwls},

        {.level = "bank", .preceding = {"ACTocwl"}, .following = {"ACTwl"}, .latency = nACToc},
        ...
        {.level = "bank", .preceding = {"NOT"}, .following = {"ACT", "ACTocwl", "ACTwl", "ACTwls", "NOT", "PRE", "PREsb", "REFsb", "RFMsb", "DRFMsb"}, .latency = nNOT},
    ...
    void set_actions() {
      ...
      // m_actions
      // Rank Actions
      m_actions[m_levels["rank"]][m_commands["PREA"]] = Lambdas::Action::Rank::PREab<DDR5PRADA>;
      m_actions[m_levels["rank"]][m_commands["REFab"]] = Lambdas::Action::Rank::REFab<DDR5PRADA>;
      m_actions[m_levels["rank"]][m_commands["REFab_end"]] = Lambdas::Action::Rank::REFab_end<DDR5PRADA>;
      m_actions[m_levels["rank"]][m_commands["RFMab"]] = Lambdas::Action::Rank::REFab<DDR5PRADA>;
      m_actions[m_levels["rank"]][m_commands["RFMab_end"]] = Lambdas::Action::Rank::REFab_end<DDR5PRADA>;
      m_actions[m_levels["rank"]][m_commands["DRFMab"]] = Lambdas::Action::Rank::REFab<DDR5PRADA>;
      m_actions[m_levels["rank"]][m_commands["DRFMab_end"]] = Lambdas::Action::Rank::REFab_end<DDR5PRADA>;
      
      // Same-Bank Actions.
      m_actions[m_levels["bankgroup"]][m_commands["PREsb"]] = Lambdas::Action::BankGroup::PREsb<DDR5PRADA>;

      // We call update_timing for the banks in other BGs here
      m_actions[m_levels["bankgroup"]][m_commands["REFsb"]]  = Lambdas::Action::BankGroup::REFsb<DDR5PRADA>;
      m_actions[m_levels["bankgroup"]][m_commands["REFsb_end"]]  = Lambdas::Action::BankGroup::REFsb_end<DDR5PRADA>;
      m_actions[m_levels["bankgroup"]][m_commands["RFMsb"]]  = Lambdas::Action::BankGroup::REFsb<DDR5PRADA>;
      m_actions[m_levels["bankgroup"]][m_commands["RFMsb_end"]]  = Lambdas::Action::BankGroup::REFsb_end<DDR5PRADA>;
      m_actions[m_levels["bankgroup"]][m_commands["DRFMsb"]] = Lambdas::Action::BankGroup::REFsb<DDR5PRADA>;
      m_actions[m_levels["bankgroup"]][m_commands["DRFMsb_end"]] = Lambdas::Action::BankGroup::REFsb_end<DDR5PRADA>;

      // Bank actions
      m_actions[m_levels["bank"]][m_commands["ACT"]] = Lambdas::Action::Bank::ACT<DDR5PRADA>;
      m_actions[m_levels["bank"]][m_commands["PRE"]] = Lambdas::Action::Bank::PRE<DDR5PRADA>;
      m_actions[m_levels["bank"]][m_commands["RDA"]] = Lambdas::Action::Bank::PRE<DDR5PRADA>;
      m_actions[m_levels["bank"]][m_commands["WRA"]] = Lambdas::Action::Bank::PRE<DDR5PRADA>;
    ...
    void set_preqs() {
      ...
      // m_preqs
      // Rank Preqs
      m_preqs[m_levels["rank"]][m_commands["REFab"]]  = Lambdas::Preq::Rank::RequireAllBanksClosed<DDR5PRADA>;
      m_preqs[m_levels["rank"]][m_commands["RFMab"]]  = Lambdas::Preq::Rank::RequireAllBanksClosed<DDR5PRADA>;
      m_preqs[m_levels["rank"]][m_commands["DRFMab"]] = Lambdas::Preq::Rank::RequireAllBanksClosed<DDR5PRADA>;

      // Same-Bank Preqs.
      m_preqs[m_levels["rank"]][m_commands["REFsb"]]  = Lambdas::Preq::Rank::RequireSameBanksClosed<DDR5PRADA>;
      m_preqs[m_levels["rank"]][m_commands["RFMsb"]]  = Lambdas::Preq::Rank::RequireSameBanksClosed<DDR5PRADA>;
      m_preqs[m_levels["rank"]][m_commands["DRFMsb"]] = Lambdas::Preq::Rank::RequireSameBanksClosed<DDR5PRADA>;

      // Bank Preqs
      m_preqs[m_levels["bank"]][m_commands["RD"]] = Lambdas::Preq::Bank::RequireRowOpen<DDR5PRADA>;
      m_preqs[m_levels["bank"]][m_commands["WR"]] = Lambdas::Preq::Bank::RequireRowOpen<DDR5PRADA>;
      m_preqs[m_levels["bank"]][m_commands["ACT"]] = Lambdas::Preq::Bank::RequireRowOpen<DDR5PRADA>;
      m_preqs[m_levels["bank"]][m_commands["PRE"]] = Lambdas::Preq::Bank::RequireBankClosed<DDR5PRADA>;
    ...
    void set_rowhits() {
      ...
      m_rowhits[m_levels["bank"]][m_commands["RD"]] = Lambdas::RowHit::Bank::RDWR<DDR5PRADA>;
      m_rowhits[m_levels["bank"]][m_commands["WR"]] = Lambdas::RowHit::Bank::RDWR<DDR5PRADA>;
    }
    ...
    void set_rowopens() {
      ...
      m_rowopens[m_levels["bank"]][m_commands["RD"]] = Lambdas::RowOpen::Bank::RDWR<DDR5PRADA>;
      m_rowopens[m_levels["bank"]][m_commands["WR"]] = Lambdas::RowOpen::Bank::RDWR<DDR5PRADA>;
    }
    ...
    void set_powers() {
      ...
      m_powers[m_levels["bank"]][m_commands["ACT"]] = Lambdas::Power::Bank::ACT<DDR5PRADA>;
      m_powers[m_levels["bank"]][m_commands["PRE"]] = Lambdas::Power::Bank::PRE<DDR5PRADA>;
      m_powers[m_levels["bank"]][m_commands["RD"]]  = Lambdas::Power::Bank::RD<DDR5PRADA>;
      m_powers[m_levels["bank"]][m_commands["WR"]]  = Lambdas::Power::Bank::WR<DDR5PRADA>;

      // m_powers[m_levels["rank"]][m_commands["REFsb"]] = Lambdas::Power::Rank::REFsb<DDR5PRADA>;
      // m_powers[m_levels["rank"]][m_commands["REFsb_end"]] = Lambdas::Power::Rank::REFsb_end<DDR5PRADA>;
      m_powers[m_levels["rank"]][m_commands["RFMsb"]] = Lambdas::Power::Rank::RFMsb<DDR5PRADA>;
      m_powers[m_levels["rank"]][m_commands["RFMsb_end"]] = Lambdas::Power::Rank::RFMsb_end<DDR5PRADA>;
      // m_powers[m_levels["rank"]][m_commands["DRFMsb"]] = Lambdas::Power::Rank::REFsb<DDR5PRADA>;
      // m_powers[m_levels["rank"]][m_commands["DRFMsb_end"]] = Lambdas::Power::Rank::REFsb_end<DDR5PRADA>;

      m_powers[m_levels["rank"]][m_commands["ACT"]] = Lambdas::Power::Rank::ACT<DDR5PRADA>;
      m_powers[m_levels["rank"]][m_commands["ACTocwl"]] = Lambdas::Power::Rank::ACT<DDR5PRADA>;
      m_powers[m_levels["rank"]][m_commands["ACTwl"]] = Lambdas::Power::Rank::ACT<DDR5PRADA>;
      m_powers[m_levels["rank"]][m_commands["ACTwls"]] = Lambdas::Power::Rank::ACT<DDR5PRADA>;
      m_powers[m_levels["rank"]][m_commands["PRE"]] = Lambdas::Power::Rank::PRE<DDR5PRADA>;
      m_powers[m_levels["rank"]][m_commands["PREA"]] = Lambdas::Power::Rank::PREA<DDR5PRADA>;
      m_powers[m_levels["rank"]][m_commands["REFab"]] = Lambdas::Power::Rank::REFab<DDR5PRADA>;
      m_powers[m_levels["rank"]][m_commands["REFab_end"]] = Lambdas::Power::Rank::REFab_end<DDR5PRADA>;
      // m_powers[m_levels["rank"]][m_commands["RFMab"]] = Lambdas::Power::Rank::REFab<DDR5PRADA>;
      // m_powers[m_levels["rank"]][m_commands["RFMab_end"]] = Lambdas::Power::Rank::REFab_end<DDR5PRADA>;
      // m_powers[m_levels["rank"]][m_commands["DRFMab"]] = Lambdas::Power::Rank::REFab<DDR5PRADA>;
      // m_powers[m_levels["rank"]][m_commands["DRFMab_end"]] = Lambdas::Power::Rank::REFab_end<DDR5PRADA>;

      m_powers[m_levels["rank"]][m_commands["PREsb"]] = Lambdas::Power::Rank::PREsb<DDR5PRADA>;
      ...
      m_prada_powers[m_levels["bank"]][m_requests["rowclone"]] = [](Node* node, ReqBuffer::iterator req_it, Clk_t clk) {
        Lambdas::Power::Bank::debug<DDR5PRADA>(node, "Incrementing RowClone count", clk);
        node->m_spec->m_power_stats[Lambdas::Power::Bank::get_flat_rank_id<DDR5PRADA>(node)].req_counters[DDR5PRADA::m_reqs_counted("rowclone")] += 1;
      };
      m_prada_powers[m_levels["bank"]][m_requests["not"]] = [](Node* node, ReqBuffer::iterator req_it, Clk_t clk) {
        Lambdas::Power::Bank::debug<DDR5PRADA>(node, "Incrementing not count", clk);
        node->m_spec->m_power_stats[Lambdas::Power::Bank::get_flat_rank_id<DDR5PRADA>(node)].req_counters[DDR5PRADA::m_reqs_counted("not")] += 1;
      };
      m_prada_powers[m_levels["bank"]][m_requests["andor"]] = [](Node* node, ReqBuffer::iterator req_it, Clk_t clk) {
        Lambdas::Power::Bank::debug<DDR5PRADA>(node, "Incrementing andor count", clk);
        node->m_spec->m_power_stats[Lambdas::Power::Bank::get_flat_rank_id<DDR5PRADA>(node)].req_counters[DDR5PRADA::m_reqs_counted("andor")] += 1;
      };
      m_prada_powers[m_levels["bank"]][m_requests["nandnor"]] = [](Node* node, ReqBuffer::iterator req_it, Clk_t clk) {
        Lambdas::Power::Bank::debug<DDR5PRADA>(node, "Incrementing nandnor count", clk);
        node->m_spec->m_power_stats[Lambdas::Power::Bank::get_flat_rank_id<DDR5PRADA>(node)].req_counters[DDR5PRADA::m_reqs_counted("nandnor")] += 1;
      };
      m_prada_powers[m_levels["bank"]][m_requests["xorxnor"]] = [](Node* node, ReqBuffer::iterator req_it, Clk_t clk) {
        Lambdas::Power::Bank::debug<DDR5PRADA>(node, "Incrementing xorxnor count", clk);
        node->m_spec->m_power_stats[Lambdas::Power::Bank::get_flat_rank_id<DDR5PRADA>(node)].req_counters[DDR5PRADA::m_reqs_counted("xorxnor")] += 1;
      };
    ...
    void process_rank_energy(PowerStats& rank_stats, Node* rank_node) {
      ...
      Lambdas::Power::Rank::finalize_rank<DDR5PRADA>(rank_node, 0, AddrVec_t(), m_clk);
