...
#include "dram_controller/injector.h" // injector
...
class IDRAMController : public Clocked<IDRAMController> {
  ...
  public:
    ...
    IInjector*   m_injector = nullptr;  // injector
  ...
  public:
    ...
    /**
     * @brief       Send a RowClone request to the memory controller.
     * 
     */
    virtual bool rowclone_send(Request& req) {
      return false; // Default implementation does not support RowClone
    };
