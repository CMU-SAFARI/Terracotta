...
class ChargeCacheOracleDRAMController final : public IDRAMController, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IDRAMController, ChargeCacheOracleDRAMController, "ChargeCacheOracleController", "A ChargeCache Oracle DRAM controller.");
  private:
  ...
  public:
    ...
    bool send(Request& req) override {
      ...
      // Every request must be marked as a ChargeCache request
      req.scratchpad[0] = 1;
