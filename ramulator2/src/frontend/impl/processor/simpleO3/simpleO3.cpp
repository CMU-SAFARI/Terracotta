  ...
  public:
    void init() override {
      ...
      for (int id = 0; id < m_num_cores; id++) {
        SimpleO3Core* core = new SimpleO3Core(id, ipc, depth, m_num_expected_insts, m_num_max_cycles, trace_list[id], m_translation, m_llc, lat_hist_sensitivity, lat_dump_path);
