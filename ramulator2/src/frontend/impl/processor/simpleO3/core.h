...
class SimpleO3Core : public Clocked<SimpleO3Core> {
  ...
  public:
    SimpleO3Core(int id, int ipc, int depth, size_t num_expected_insts, uint64_t num_max_cycles, std::string trace_path, ITranslation* translation, SimpleO3LLC* llc, int lat_hist_sens, std::string& dump_path);
