...
# Zenodo deposit of the trace archive. TRACES_SHA256 is the checksum of the archive built
# from this artifact's traces/ (57 CPU + 8 PuM traces). TRACES_URL is filled once the record
# is published (see CLAUDE.md).
TRACES_URL = "https://zenodo.org/records/21456640/files/terracotta_traces.tar.gz?download=1"
