...
# Zenodo deposit of the trace archive: Terracotta artifact record 21535720 (same record as the
# tagged source release). TRACES_SHA256 is the sha256 of terracotta_traces.tar.gz
# (57 CPU + 8 PuM traces).
TRACES_URL = "https://zenodo.org/records/21535720/files/terracotta_traces.tar.gz?download=1"
